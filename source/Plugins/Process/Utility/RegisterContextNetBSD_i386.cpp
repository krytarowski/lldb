...
// http://svnweb.netbsd.org/base/head/sys/x86/include/reg.h
struct GPR
{
    uint32_t fs;
    uint32_t es;
...
RegisterContextNetBSD_i386::RegisterContextNetBSD_i386(const ArchSpec &target_arch) :
    RegisterInfoInterface(target_arch)
{
}

size_t
RegisterContextNetBSD_i386::GetGPRSize() const
{
    return sizeof(GPR);
}
...
uint32_t
RegisterContextNetBSD_i386::GetRegisterCount () const
{
